...
\hspace{32mm}\makebox[5cm][s]
{學\qquad 生：\quad 王\quad 樟\quad 皓\quad(41023114)}\\[6pt]
\hspace{32mm}\makebox[5cm][s]
...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    \noindent \fontsize{15pt}{16pt}\selectfont 分組報告製作修習學生\enspace:\quad
           {\begin{minipage}[t]{10em}\underline{四設二甲\enspace 41023114 王樟皓}\\ \underline{四設二甲\enspace 41023126\enspace 第二位}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
...
%\end{landscape}
\end{document}
>>>>>>> b11cd495e1e2aca2a6c2b650f1cc34879e7bec09
